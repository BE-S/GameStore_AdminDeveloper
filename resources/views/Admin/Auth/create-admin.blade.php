...
@section('content')
    <div class='container w-50'>
        ...
        <div class="row mb-3">
            <div class="col-sm-10 w-100">
                <input type="last-name" class="form-control form-control-sm" id="InputEmail" placeholder="Фамилия">
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-sm-10 w-100">
        ...
        <div class="row mb-3">
            <div class="col-sm-10 w-100">
                <input type="phone" class="form-control form-control-sm" id="InputPhone" placeholder="номер телефона">
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-sm-10 w-100">
        ...
        <div class="row mb-3">
            <div class="col-sm-10 w-100">
                <input type="rang" class="form-control form-control-sm" id="InputRang" placeholder="Ранг">
            </div>
        </div>
